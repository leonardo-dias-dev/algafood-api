...
public interface UsuarioControllerOpenApi {
    ...
    UsuarioModel adicionar(@ApiParam(name = "corpo", value = "Representação de um novo usuário", required = true) UsuarioComSenhaInput usuarioComSenhaInput);
    ...
    UsuarioModel atualizar(@ApiParam(value = "ID do usuário", example = "1", required = true) Long id,
