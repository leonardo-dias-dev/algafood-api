...
public class VendaQueryServiceImpl implements VendaQueryService {
    ...
    public List<VendaDiariaModel> consultarVendasDiarias(VendaDiariaFilter vendaDiariaFilter, String timeOffset) {
        ...
        var criteriaQuery = criteriaBuilder.createQuery(VendaDiariaModel.class);
        ...
        var compoundSelection = criteriaBuilder.construct(VendaDiariaModel.class, functionDateDataCriacao, countId, sumValorTotal);
